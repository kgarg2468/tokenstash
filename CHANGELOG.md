...
- Linux binaries are static (musl) and run on any distribution; the 0.1 builds required glibc ≥ 2.39. The crates (`tokenstash`, `tokenstash-core`) package correctly for `cargo install tokenstash`.
